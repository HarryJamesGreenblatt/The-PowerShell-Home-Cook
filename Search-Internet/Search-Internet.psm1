...
<#
    ...
    If specified, Invokes a Web Request to retreive HTML belonging to the page generated by entering 
    the Search Query, returning the result as a Powershell Object
...
#>
    ...
    process {
        ...
        If( -not ($DontOpenBrowser) ){
            ...
            Write-Verbose "Now opening up a Search Query on '$Question' in '$Browser' using the '$SearchEngine' Search Engine`n`n"
